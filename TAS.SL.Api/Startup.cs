...
namespace TAS.SL.Api
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ServicoLanceContexto>(opcao => opcao.UseInMemoryDatabase("ServicoLance"));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                var context = serviceScope.ServiceProvider.GetService<ServicoLanceContexto>();
